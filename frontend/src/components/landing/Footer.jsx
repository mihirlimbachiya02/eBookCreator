import { BookOpen } from "lucide-react"; // Only keep the book icon which we know works perfectly!
    ...
    return (
        <footer className="relative bg-gradient-to-br from-gray-950 via-gray-950 to-violet-950 text-white overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto px-6 lg:px-8 py-12 relative z-10">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="flex flex-col items-start text-left space-y-4">
                        ...
                        >
                            ...
                            <span className="text-gray-100">eBook Creator</span>
                        </a>
                        ...
                        <div className="flex items-center space-x-4 pt-2">
                            ...
                            <a
                                ...
                                className="w-9 h-9 rounded-lg bg-gray-900 border border-gray-800 flex items-center justify-center text-gray-400 hover:text-white transition-colors"
                                aria-label="Twitter"
                            >
                                <svg
                                    className="w-4 h-4"
                ...
                {/* Bottom Bar Details */}
                <div className="mt-12 pt-6 border-t border-gray-900/60 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-gray-500">
                    <p>
                        © {new Date().getFullYear()} eBook Creator. All rights
                        reserved.
                    </p>
                </div>
            </div>
