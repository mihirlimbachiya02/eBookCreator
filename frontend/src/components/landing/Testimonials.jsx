        ...
        >
            ...
            <div className="max-w-7xl mx-auto px-6 lg:px-8 relative">
                ...
                <div className="text-center mb-14 space-y-4">
                    ...
                    <h2 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 tracking-light">
                        Loved by Creators
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {TESTIMONIALS.map((testimonial, index) => (
                        <div
                            key={index}
                            className="group relative bg-white/80 backdrop-blur-sm rounded-3xl p-8 border border-gray-100 hover:border-violet-200 transition-all duration-300 hover:shadow-2xl hover:shadow-violet-500/10 hover:-translate-y-2"
                        >
                            {/* Quote Icon */}
                            <div className="absolute -top-4 -left-4 w-12 h-12 bg-gradient-to-br from-violet-500 to-purple-600 rounded-2xl flex items-center justify-center shadow-lg shadow-violet-500/30 rotation-6 group-hover:rotate-120 transition-transform duration-300">
                            ...
                            <div className="absolute inset-0 bg-gradient-to-br from-violet-50/0 to-purple-50/0 group-hover:from-violet-50/50 group-hover:to-purple-50/50 rounded-3xl transition-all duration-300 -z-10"></div>
                        </div>
                    ))}
                </div>
